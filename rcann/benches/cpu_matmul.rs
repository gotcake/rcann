...
impl_bench!(cpu_f32_lg, f32, get_square_matmul_tensors, MATRIX_SIZE_LG, 1.0, false, false, 0.0, false);
impl_bench!(cpu_f32_md, f32, get_square_matmul_tensors, MATRIX_SIZE_MD, 1.0, false, false, 0.0, false);
impl_bench!(cpu_f32_sm, f32, get_square_matmul_tensors, MATRIX_SIZE_SM, 1.0, false, false, 0.0, false);
benchmark_group!(cpu_f32, cpu_f32_lg, cpu_f32_md, cpu_f32_sm);

impl_bench!(cpu_f64_lg, f64, get_square_matmul_tensors, MATRIX_SIZE_LG, 1.0, false, false, 0.0, false);
impl_bench!(cpu_f64_md, f64, get_square_matmul_tensors, MATRIX_SIZE_MD, 1.0, false, false, 0.0, false);
impl_bench!(cpu_f64_sm, f64, get_square_matmul_tensors, MATRIX_SIZE_SM, 1.0, false, false, 0.0, false);
